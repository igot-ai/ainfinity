...
def parse_args():
    ...
    parser.add_argument("--model_name", type=str, default="unsloth/llama-3-8b-bnb-4bit", help="Base model name")
...
def main():
    ...
    tracker.log_metrics(
        {"train_runtime": trainer_stats.metrics["train_runtime"], "train_loss": trainer_stats.metrics["train_loss"]}
    )
